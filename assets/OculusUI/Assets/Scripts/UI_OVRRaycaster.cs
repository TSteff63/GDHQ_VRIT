...
public class UI_OVRRaycaster : GraphicRaycaster, IPointerEnterHandler
{
    [Tooltip("A world space pointer for this canvas")]
    public GameObject pointer;
    

    protected UI_OVRRaycaster()
    { }
    ...
    {
        UI_OVRRayPointerEventData rayPointerEventData = eventData as UI_OVRRayPointerEventData;
    ...
    {
        UI_OVRInputModule inputModule = EventSystem.current.currentInputModule as UI_OVRInputModule;
        return inputModule && inputModule.activeGraphicRaycaster == this;
    }
    
    public void OnPointerEnter(PointerEventData e)
    {
        PointerEventData ped = e as UI_OVRRayPointerEventData;
        if (ped != null)
        {
