...
public class UI_OVRGazePointer : MonoBehaviour {
    ...
    private static UI_OVRGazePointer _instance;
    public static UI_OVRGazePointer instance 
    { 
        ...
        get
        {
            if (_instance == null)
            {
                ...
                _instance = (UI_OVRGazePointer)GameObject.Instantiate((UI_OVRGazePointer)Resources.Load("Prefabs/GazePointerRing", typeof(UI_OVRGazePointer)));
            }
            return _instance;
        }
