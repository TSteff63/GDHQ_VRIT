...
[RequireComponent(typeof(UI_OVRGazePointer))]
public class UI_ParticleGazeCursor : MonoBehaviour
{
    ...
    UI_OVRGazePointer gazePointer;

    // Use this for initialization
    void Start()
    {
        gazePointer = GetComponent<UI_OVRGazePointer>();
    ...
    void Update()
    {
        var delta = GetComponent<UI_OVRGazePointer>().positionDelta;
