...
{
    public class UI_OVRInputModule : PointerInputModule
    {
       ...
       // private OVRRaycaster _activeGraphicRaycaster;
        [NonSerialized]
        public UI_OVRRaycaster activeGraphicRaycaster;
        [Header("Dragging")]
       ...
       private static bool UseMouse(bool pressed, bool released, PointerEventData pointerData)
        ...
        protected void CopyFromTo(UI_OVRRayPointerEventData @from, UI_OVRRayPointerEventData @to)
        {
...
#region PointerEventData pool
        ...
        protected Dictionary<int, UI_OVRRayPointerEventData> m_VRRayPointerData = new Dictionary<int, UI_OVRRayPointerEventData>();

        
        protected bool GetPointerData(int id, out UI_OVRRayPointerEventData data, bool create)
        {
            if (!m_VRRayPointerData.TryGetValue(id, out data) && create)
            {
                data = new UI_OVRRayPointerEventData(eventSystem)
                {
                    pointerId = id,
                };
        ...
        protected MouseState GetGazePointerData()
        {
            ...
            UI_OVRRayPointerEventData leftData;
            ...
            UI_OVRRaycaster ovrRaycaster = raycast.module as UI_OVRRaycaster;
            ...
            if (ovrRaycaster) 
            {
                ...
                if (graphicRect != null)
                {
                    ...
                    UI_OVRGazePointer.instance.SetPosition(worldPos, normal);
                    // Make sure it's being shown
                    UI_OVRGazePointer.instance.RequestShow();
                }
            }
            UI_OVRPhysicsRaycaster physicsRaycaster = raycast.module as UI_OVRPhysicsRaycaster;
            if (physicsRaycaster)
            {
                leftData.position = physicsRaycaster.GetScreenPos(raycast.worldPosition);
                UI_OVRGazePointer.instance.RequestShow();
                UI_OVRGazePointer.instance.SetPosition(raycast.worldPosition, raycast.worldNormal);
            }
            ...
            UI_OVRRayPointerEventData rightData;
            GetPointerData(kMouseRightId, out rightData, true );
            CopyFromTo(leftData, rightData);
            rightData.button = PointerEventData.InputButton.Right;

            UI_OVRRayPointerEventData middleData;
        ...
        private bool ShouldStartDrag(PointerEventData pointerEvent)
        {
            ...
            if (pointerEvent as UI_OVRRayPointerEventData == null)
            {
        ...
        {
            UI_OVRRayPointerEventData rayPointerEventData = pointerEvent as UI_OVRRayPointerEventData;
